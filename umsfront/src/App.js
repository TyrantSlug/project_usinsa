      ...
      <BrowserRouter>
        <div>
          <Routes>
            ...
            <Route
              path="/member-service/orderList/:username"
            ...
            <Route
              path="/member-service/detail/:username"
              element={<MemberDetail />}
            />
            <Route path="/member-service/insert" element={<MemberInsert />} />
            <Route
              path="/member-service/updateName/:username"
              element={<MemberUpdateName />}
            />
            <Route
              path="/member-service/updatePassword/:username"
              element={<MemberUpdatePassword />}
            />
            <Route
              path="/member-service/delete/:username"
              element={<MemberDelete />}
            />
            <Route
              path="/member-service/memberReply/:username"
              element={<MemberReplyList />}
            />

            <Route path="/item-service/insert" element={<ItemInsert />} />
            <Route path="/item-service/detail/:id" element={<ItemDetail />} />
            <Route
              path="/item-service/list/itemType/:itemType"
              element={<ItemListType />}
            />
            <Route
              path="/item-service/list/username/:username"
              element={<ItemListOfStaff />}
            />
            <Route path="/item-service/list" element={<ItemList />} />
            <Route path="/item-service/update/:id" element={<ItemUpdate />} />
            <Route
              path="/item-service/search/:keyword"
              element={<ItemSearchList />}
            />
