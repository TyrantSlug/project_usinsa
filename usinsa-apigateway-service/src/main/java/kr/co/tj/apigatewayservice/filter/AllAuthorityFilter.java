...
@Component
public class AllAuthorityFilter extends AbstractGatewayFilterFactory<AllAuthorityFilter.Config> {
	
	//private static final String SECRET_KEY = "aaaaaaaaaaaaaaaa";
	
	private Environment env;
	
	public AllAuthorityFilter(Environment env) {
		super(Config.class);
...
//		System.out.println(config.num1);
	...
	private boolean haveAuthority(String token) {
		...
		if(authority.equals("ROLE_USER") || authority.equals("ROLE_MANAGER") || authority.equals("ROLE_ADMIN")) {
			isValid = true;
		}
