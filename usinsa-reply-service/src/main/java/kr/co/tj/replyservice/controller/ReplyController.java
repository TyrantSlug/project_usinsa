...
public class ReplyController {
	...
	@GetMapping("replys/username/{username}")
...
//	}
	...
	public ResponseEntity<?> insert(@RequestBody ReplyRequest replyRequest) {
		...
		if (replyRequest == null || replyRequest.getUsername() == null || replyRequest.getUsername().isEmpty()
				|| replyRequest.getContent() == null || replyRequest.getContent().isEmpty()) {
...
//	}
	...
	public ResponseEntity<?> update(@RequestBody ReplyRequest replyRequest) {
		...
		if (replyRequest == null || replyRequest.getId() == null || replyRequest.getId() == 0L
				|| replyRequest.getUsername() == null || replyRequest.getUsername().isEmpty()
				|| replyRequest.getContent() == null || replyRequest.getContent().isEmpty()) {
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("잘못된 접근입니다.");
		}
